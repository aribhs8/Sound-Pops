...
//693575/529497/2.49/3/3/MOSFET N-Channel
...
(library Library_1
	...
	(symbolDef "SI2312BDS-T1-E3" (originalName "SI2312BDS-T1-E3")
	...
	(compDef "SI2312BDS-T1-E3" (originalName "SI2312BDS-T1-E3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SI2312BDS-T1-E3"))
		...
		(attr "Mouser Part Number" "781-SI2312BDS-E3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Semiconductors/SI2312BDS-T1-E3?qs=jcx%252B0HVgj2b3YhM4OoQ%252BrQ%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SI2312BDS-T1-E3")
		(attr "Description" "N-Channel 20 V (D-S) MOSFET")
		(attr "<Hyperlink>" "http://www.vishay.com/docs/73235/si2312bds.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SI2312BDS-T1-E3.stp")
